...
const baseColor = (option = {}, text, type) => {
    const { color = model_1.ColorType.white, bgColor = model_1.ColorType.white } = option;
...
const padText = {
    ...
    warn(text = "beautify-console-log ", style = { bgColor: model_1.ColorType.yellow, color: model_1.ColorType.black }) {
